...
begin
  ...
  Produto.Custo := StrToCurr(StringReplace(edCusto.Text,'.','',[rfReplaceAll]));
end;
...
procedure TFrmCadastroProdutos.DBGrid1DrawColumnCell(Sender: TObject;
...
procedure TFrmCadastroProdutos.edFiltroChange(Sender: TObject);
begin
  ...
  begin
    ...
    begin
      cdsProdutos.Filter := 'Nome like ''%' +edFiltro.Text +'%''';
    end
    else
      cdsProdutos.Filter := 'Id='+edFiltro.Text;
